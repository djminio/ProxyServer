...
public:
	...
	// 011121 KBS
	DWORD					BroadCastMapServer(char* pMsg, DWORD dwLength);
	DWORD					BroadCastDBDemon(char* pMsg, DWORD dwLength);
	DWORD					BroadCastAgentServer(char* pMsg, DWORD dwLength);
	//
...
//	void					CollectTransStatistics( DWORD dwType, DWORD size );
	...
	//Added by KBS 011206
	bool					DestroyDBDemon( LP_SERVER_DATA pServerData );
	//
