...
enum PTCL
{
	...
	PTCL_PROXY_TO_LOGOUT						=	104, // PROXY에서 제거
	//> CSD-030322	
	PTCL_RM										=	110,			//LISTENER_TO_PROXY	// BBD 040311

	PTCL_SERVERSET_USERNUM_REQUEST				=	120,	// BBD 040311	동접수 요청
};
...
{
	DWORD					dwErrorCode;
	char					szError[128]; //Eleval 21/08/09 - Put 128 to prevent any buffer too small error
